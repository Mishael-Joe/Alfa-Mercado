...
export async function POST(request: Request) {
  ...
  if (hash == signature) {
    ...
    try {
      ...
      const cartItems = result.data.metadata.itemsInCart;
      ...
      const resultTransactionReference = chargeData.reference;
      // console.log('transactionReference', transactionReference);
      ...
      // console.log('response webhooks verification', result);
    } catch (error: any) {
      throw new Error('Error varifying transaction', error);
    }
  } else {
