  ...
  return (
    <div className=' md:max-w-5xl md:container md:mx-auto min-h-screen my-auto flex justify-center items-center'>
      <div className='py-8 px-4 flex flex-col gap-4'>
        ...
        <p><span className='font-semibold text-lg'>Children's Privacy:</span> Our services are not intended for individuals under the age of 15. We do not knowingly collect personal information from children.</p>

        <p><span className='font-semibold text-lg'>Changes to this Privacy Policy:</span> - We may update this Privacy Policy periodically. The <strong>Effective Date</strong> will indicate the most recent revisions.</p>
